...
import { demoImage } from '../../shared/parts/chatui'
			...
			<Section title="Basics">
				<Group gap="sm" align="center">
					...
					<Group gap="sm" align="center">
						...
						<Button variant="text" onClick={() => toast.success('Saved')}>
							Toast
						</Button>
					</Group>
			...
			<Section title="Inputs & Forms">
				...
				>
					...
					options={[
						...
						value={checkboxValue}
						onChange={(value) => setCheckboxValue(value.filter((v): v is string | number => v != null))}
					/>
				<RadioGroup
					options={[
						{ label: 'Alpha', value: 'alpha' },
						...
						value={radioValue}
						onChange={(value) => {
							if (value != null) setRadioValue(value)
						}}
					/>
					<Form>
