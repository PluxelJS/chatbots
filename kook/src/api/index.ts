...
function buildKookApi(request: KookRequest): KookApi {
  ...
  for (const [name, method, path] of AUTO_ENDPOINTS) {
    define(name as keyof KookAutoApi, method, path)
  }
